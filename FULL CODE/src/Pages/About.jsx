...
import founder from "../assets/boss.png";
  ...
  return (
    <div className="bg-full bg-fixed text-white bg-center bg-cover">
      <div className="h-[100%]hero w-full ">
        ...
        <div className=" md:w-[80%] w-[95%] m-auto flex flex-col justify-center  py-[30px]">
          <div className="welcome ">
            <div className="title">
              <h1
                className="text-center font-bold md:text-[40px] text-[30px]"
                data-aos="zoom-in"
              >
        ...
        <div className="values p-10 bg-about bg-cover bg-center text-white">
          ...
          <div className="items flex flex-wrap justify-center">
            <div
              className="flex flex-col w-[500px] border-[3px] p-2 bg-gray-800  my-2"
              data-aos="zoom-in"
            >
            ...
            <div
              className="flex flex-col w-[500px] border-[3px] p-2 bg-gray-700 my-2"
              data-aos="zoom-in"
            >
              <div className="title2">
                <h1
        ...
        <div className="story md:p-10 p-4 bg-city bg-cover bg-center text-white">
          <div className="title">
            <h1
              className="text-center font-bold text-[40px]"
              data-aos="zoom-in"
          ...
          <div className="begin flex flex-col md:flex-row justify-between md:w-[80%] m-auto ">
            <div className="text md:mx-5">
              ...
              <p className="text-[20px] my-3  text-left" data-aos="zoom-in">
            ...
            <div className="founder">
              ...
              />
              <div
                className="bg-white border-[3px] p-4 rounded-t-xl"
                data-aos="zoom-in"
              >
