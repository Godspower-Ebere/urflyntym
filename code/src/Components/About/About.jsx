...
export const About = () => {
  ...
  return (
    <div
      className="h-[100%]hero w-full bg-blue-100"
      ...
      <div className=" w-[80%] m-auto flex flex-col justify-center  py-[30px]">
        ...
        <div className="bg-about bg-center bg-cover section1 md:flex block w-[100%] justify-between">
          ...
          <div className="md:w-[48%] flex justify-center items-center">
            <p
              data-aos="zoom-in"
              className="text-[20px] text-left md:text-justify m-[auto] font-bold text-white md:p-10"
            >
        ...
        <div className="mt-10 section1 bg-mission bg-center bg-cover flex flex-col-reverse md:flex-row w-[100%] justify-between">
          <div className="md:w-[48%]">
            ...
            <p
              data-aos="zoom-in"
              className="text-[20px] text-left text-white md:text-justify m-[auto] font-bold md:p-10"
            >
